...
NAME_FIELD_CANDIDATES = (
    ...
    'cat_lbl_1', 'acm_lbl_1', 'dng_lbl_1', 'tma_lbl_1', 'alt_lbl_1',
    'rfl_lbl_1', 'uac_lbl_1', 'fld_lbl_1', 'str_nam',
    'riv_nm', 'rn', 'buld_nm',
)
...
SPECS: list[dict] = [
    ...
    dict(code='접근관제구역', layer_id='lt_c_aistmac', role='REGULATION',
         category='안전/문화재', default_status='CONDITIONAL', default_difficulty='HIGH',
         altitude_floor_field='tma_lbl_3',
         law='공항시설법', article='제34조(장애물 제한표면)',
         action_required='공항 접근관제구역은 장애물 제한표면이 적용됩니다. '
                         '발전기 최고높이가 제한표면을 넘는지 국토교통부에 질의하십시오.',
         display_order=99),
    dict(code='경계구역', layer_id='lt_c_aisaltc', role='REGULATION',
         category='안전/문화재', default_status='CONDITIONAL', default_difficulty='HIGH',
         altitude_floor_field='alt_lbl_3',
         law='군사기지 및 군사시설 보호법', article='제13조',
         action_required='군 경계구역은 관할부대 협의 대상입니다.', display_order=100),
    dict(code='공중급유구역', layer_id='lt_c_aisrflc', role='REGULATION',
         category='안전/문화재', default_status='CONDITIONAL', default_difficulty='MEDIUM',
         altitude_floor_field='rfl_lbl_3',
         law='군사기지 및 군사시설 보호법', article='제13조', display_order=101),
    dict(code='초경량비행장치공역', layer_id='lt_c_aisuac', role='CONTEXT',
         category='안전/문화재', default_status='POSSIBLE', default_difficulty='LOW',
         altitude_floor_field='uac_lbl_3',
         law='항공안전법', article='제129조(초경량비행장치 조종자 준수사항)',
         action_required='초경량비행장치 공역과 겹치면 운영 단계에서 충돌 위험 관리가 필요합니다.',
         display_order=102),
    dict(code='헬기장', layer_id='lt_p_aishcstrip', role='DISTANCE',
         category='안전/문화재', default_status='CONDITIONAL', default_difficulty='HIGH',
         proximity_m=3000,
         law='공항시설법', article='제34조(장애물 제한표면)',
         action_required='헬기장 주변은 진입·전이표면이 설정됩니다. 최근접 헬기장과의 '
                         '거리·방위를 확인해 장애물 제한표면 저촉 여부를 질의하십시오.',
         display_order=103),
    dict(code='경량항공기이착륙장', layer_id='lt_c_aisfldc', role='DISTANCE',
         category='안전/문화재', default_status='CONDITIONAL', default_difficulty='MEDIUM',
         proximity_m=3000,
         law='항공안전법', article='제108조(경량항공기 비행)', display_order=104),
