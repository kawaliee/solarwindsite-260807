...
STEPS: list[dict] = [
    ...
    dict(phase='PERMIT', name='국가유산 영향진단 (매장유산 지표조사 포함)',
         depends_on=['발전사업허가'],
         ...
         statutory_basis='UNKNOWN',
         note='**조문을 확정했다(2026-08 원문 대조).** 2024-02-13 개정으로 매장유산법의 '
              '사업시행자 지표조사 의무(구 제6조)가 삭제되고 그 의무가 「국가유산영향진단법」 '
              '제9조로 옮겨갔다. 현행 매장유산법 제6조의2는 국가·지방자치단체가 하는 '
              '지표조사이고 제7조도 그 보고서 제출만 남아, 사업시행자 근거로 쓸 수 없다. '
              '매장유산 유존지역에서 시행하는 건설공사는 제9조제1항제2호로 영향진단 대상이며, '
              '대상이 아닌 역사문화환경 보존지역 공사는 제17조의 약식영향진단을 시장·군수가 '
              '실시한다. 대상 규모(제9조제1항제1호)는 같은 법 시행령으로 확정해야 한다.'),
