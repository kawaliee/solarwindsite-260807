...
STEPS = [
    ...
    # ── 국토계획법 경로는 **용도지역으로 갈린다.** 아래 둘은 함께 밟는
    #    절차가 아니라 택일이다(법 제56조제1항 단서 — 도시·군계획사업에
    #    의한 행위는 개발행위허가를 받지 않는다).
    dict(order=69, phase='PERMIT',
         ...
         note='풍력발전시설은 국토계획법상 기반시설인 「전기공급설비」다'
              ...
              '따라서 도시지역(녹지지역 포함)·지구단위계획구역에 걸치면 도시계획시설로 '
              '결정한 뒤 법 제88조의 실시계획 인가를 받아야 하고, 그때는 법 제56조제1항 '
              '단서에 따라 개발행위허가를 받지 않는다. '
              '⚠️ 분기 기준은 **용도지역**이며 설비용량이나 사업면적이 아니다. '
